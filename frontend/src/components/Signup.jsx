    ...
    return (
        <>
            ...
            <div className='flex h-screen items-center justify-center '>
                <form action='' className='border border-gray-700 px-6 py-2 rounded space-y-3 w-[400px] h-[420px]'>
                 ...
                 <span className='text-yellow-800 font-bold'>App</span></h1>
                    ...
                    <div className='flex justify-between'>
                        ...
                        <input type='submit' value='Signup' className='text-white bg-green-500 px-3 py-1 rounded-lg'/>
                    </div>
                </form>
            </div>
        </>
